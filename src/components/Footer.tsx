        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Your trusted partner for premium baby and kids products. Safe, quality items for your little ones' growth and happiness.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300 text-sm">support@babybloom.com</span>
              </div>
              <div className="flex items-start space-x-3">
                <MapPin className="w-4 h-4 text-purple-400 flex-shrink-0 mt-0.5" />
                <span className="text-gray-300 text-sm">
                  123 Kids Street, Mumbai, Maharashtra 400001
                </span>
              </div>
            </div>
          </div>
